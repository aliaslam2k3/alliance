    ...
    <div className="font-inter bg-white text-gray-800">
      ...
      <section className="relative h-[70vh] flex items-center justify-center bg-brand-black">
        <div className="absolute inset-0">
          <Image src="/images/proj5.png" alt="Shabbir Town, Lahore" fill className="object-cover opacity-60" />
        </div>
        <div className="relative z-10 text-center text-white max-w-4xl px-4">
          <h1 className="text-6xl font-playfair font-bold mb-4">Shabbir Town, Lahore</h1>
          <p className="text-xl text-gray-200 mb-6">Commercial</p>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">Mixed-use commercial development featuring retail, office, and residential spaces.</p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  A comprehensive mixed-use development combining retail, office, and residential spaces in a modern urban setting.
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-xl font-bold mb-3">Key Features</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Retail spaces</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Office complexes</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Residential units</span></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-3">Technical Specifications</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Modern infrastructure</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Parking facilities</span></li>

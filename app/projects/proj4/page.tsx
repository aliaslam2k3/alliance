    ...
    <div className="font-inter bg-white text-gray-800">
      ...
      <section className="relative h-[70vh] flex items-center justify-center bg-brand-black">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl px-4">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">Modern textile manufacturing facility with eco-friendly production processes.</p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  A state-of-the-art textile manufacturing facility designed for sustainable production with modern machinery and eco-friendly processes.
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-xl font-bold mb-3">Key Features</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Modern production lines</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Quality control systems</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Eco-friendly processes</span></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-3">Technical Specifications</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Automated machinery</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Waste management systems</span></li>
                      <li className="flex"><i className="fas fa-check text-brand-yellow mt-1 mr-3"></i><span>Energy-efficient systems</span></li>
                    </ul>
                  </div>
                </div>
              </div>
